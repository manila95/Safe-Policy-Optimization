...
from safepo.common.wrappers import ShareSubprocVecEnv, ShareDummyVecEnv, ShareEnv, SafeNormalizeObservation, SafeGymNormalizeObservation, MultiGoalEnv
...
def make_sa_gymrobot_env(args, num_envs: int, env_id: str, seed: int|None = None, max_episode_steps: int = 1000):
    """
