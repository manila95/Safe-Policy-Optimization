...
def single_agent_args():
    custom_parameters = [
        ...
        {"name": "--max-episode-steps", "type": int, "default": 1000, "help": "The maximum episode steps"},
        {"name": "--dynamic-steps", "type": lambda x: bool(strtobool(x)), "default": False, "help": "Whether to use dynamic stepsize"},
        {"name": "--curriculum-bins", "type": int, "default": 10, "help": "Number of curriculum bins for dynamic stepsize"},
