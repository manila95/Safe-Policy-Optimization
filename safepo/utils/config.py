...
def single_agent_args():
    custom_parameters = [
        ...
        {"name": "--log-dir", "type": str, "default": "/logs/runs", "help": "directory to save agent logs"},
        ...
        {"name": "--fear-radius", "type": int, "default": 40, "help": "Fear radius for binary classifier risk"},
        ...
        {"name": "--risk-update-period", "type": int, "default": 1, "help": "which type of risk network to use"},
        ...
        {"name": "--num-steps", "type": int, "default": 1000, "help": "number of steps in an episode"},
        {"name": "--action-noise", "type": float, "default": 0.0, "help": "action noise "},
        ...
        {"name": "--cost-multiplier", "type": float, "default": 1, "help": "initial value of lagrangian multiplier"},
