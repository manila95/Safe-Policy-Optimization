...
def single_agent_args():
    custom_parameters = [
        ...
        {"name": "--early-termination", "type": lambda x: bool(strtobool(x)), "default": False, "help": "Do you terminate when cost limit exceeded"},
        {"name": "--term-cost", "type": int, "default": 1, "help": "Cost threshold to terminate over"},
        ...
        {"name": "--num-envs", "type": int, "default": 5, "help": "The number of parallel game environments"},
        ...
        {"name": "--fear-radius", "type": int, "default": 25, "help": "Fear radius for binary classifier risk"},
        {"name": "--risk-input", "type": str, "default": "state", "help": "which type of risk network to use"},
        ...
        {"name": "--start-risk-update", "type": int, "default": 0, "help": "Total timesteps of the experiments"},
        ...
        {"name": "--use-sam-cost-critic", "type": lambda x: bool(strtobool(x)), "default": False, "help": "Whether to use SAM for critic update"},
        {"name": "--use-sam-reward-critic", "type": lambda x: bool(strtobool(x)), "default": False, "help": "Whether to use SAM for reward critic update"},
